...
namespace UrunSatisSitesi.Entities
{
    public class Product : IEntity
    {
        ...
        [Display(Name = "Kategori")]
        public virtual Category? Category { get; set; } //1 ürünün 1 tane kategorisi olabilir
        [Display(Name = "Marka")]
        public int BrandId { get; set; } ////1 ürünün 1 tane markası olabilir (1e 1 ilişki türü)
        [Display(Name = "Marka")]
