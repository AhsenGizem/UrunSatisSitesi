...
namespace UrunSatisSitesi.Entities
{
    public class Category : IEntity
    {
        ...
        public ICollection<Product> Products { get; set; }//Kategori ile Product arasında bire çok ilişki kurduk. 1 kategorinin 1den çok ürünü olabilir (Bire çok ilişki)
        public Category()
        {
